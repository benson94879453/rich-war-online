...
| PB-042 | [#68](https://github.com/benson94879453/rich-war-online/issues/68) | P1 | Docs | In Progress | sprint6 | Plan GameManager decomposition baseline | Sprint6 plan, scope, out-of-scope items, issue order, validation expectations, and branch strategy are documented. |
| PB-043 | [#69](https://github.com/benson94879453/rich-war-online/issues/69) | P1 | Tech Debt | Planned | sprint6 | Extract snapshot summary tracking from GameManager | Snapshot UI summary state and formatting are delegated while snapshot payload compatibility remains intact. |
| PB-044 | [#70](https://github.com/benson94879453/rich-war-online/issues/70) | P1 | Tech Debt | Planned | sprint6 | Extract property purchase and rent resolution boundary | Current Buy, Skip, insufficient-funds, purchase offer, and rent behavior live behind a focused boundary without behavior changes. |
| PB-045 | [#71](https://github.com/benson94879453/rich-war-online/issues/71) | P1 | Tech Debt | Planned | sprint6 | Extract landing resolution orchestration boundary | Landing sequencing delegates through a focused resolver while property, rent, money tile, and `starq_chance` behavior remains stable. |
| PB-046 | [#72](https://github.com/benson94879453/rich-war-online/issues/72) | P1 | Review | Planned | sprint6 | Record GameManager decomposition acceptance review | Sprint6 evidence is summarized with remaining risks and a clear recommendation for the next gameplay-system slice. |
