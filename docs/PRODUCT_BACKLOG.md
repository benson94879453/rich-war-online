...
| PB-018 | [#13](https://github.com/benson94879453/rich-war-online/issues/13) | P2 | Test | Todo | sprint1 | Plan map validation smoke script | Decide whether to add a Godot script that runs existing `BoardData` validation helpers. |
