...
| PB-031 | [#42](https://github.com/benson94879453/rich-war-online/issues/42) | P1 | Docs | In Progress | sprint4 | Record action/effect foundation planning baseline | Sprint4 plan, scope, out-of-scope items, issue order, validation expectations, and branch strategy are documented. |
| PB-032 | [#43](https://github.com/benson94879453/rich-war-online/issues/43) | P1 | Tech Debt | Planned | sprint4 | Introduce ActionDispatcher baseline | Existing roll, route choice, Buy, and Skip actions can flow through a single dispatch entry point while Host authority remains intact. |
| PB-033 | [#44](https://github.com/benson94879453/rich-war-online/issues/44) | P1 | Tech Debt | Planned | sprint4 | Introduce EffectService baseline | Current tile money effects keep working through a shared effect service entry point that can later support cards, events, statuses, and buildings. |
| PB-034 | [#45](https://github.com/benson94879453/rich-war-online/issues/45) | P1 | Tech Debt | Planned | sprint4 | Expand TurnSystem FSM baseline | Turn phase vocabulary supports explicit future intervention windows while existing movement, route, property, and rent flows remain stable. |
| PB-035 | [#46](https://github.com/benson94879453/rich-war-online/issues/46) | P1 | Tech Debt | Planned | sprint4 | Add GameState snapshot reserved fields | Future hand, deck, discard, status, pending-intervention, and game-over fields have stable defaults and survive snapshot round-trip. |
| PB-036 | [#47](https://github.com/benson94879453/rich-war-online/issues/47) | P2 | Test | Planned | sprint4 | Add scenario smoke baseline | At least one narrow scenario smoke path exists and is documented as the extension point for later event/building/card scenarios. |
