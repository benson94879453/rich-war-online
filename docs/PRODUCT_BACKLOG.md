...
| PB-058 | [#100](https://github.com/benson94879453/rich-war-online/issues/100) | P1 | Story | In Review | sprint8 | Implement minimal active-scene card hand UI | After #99 confirmation, the prototype card can be seen, inspected, played during pre-roll, or skipped by rolling. |
