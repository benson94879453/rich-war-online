...
| PB-056 | [#98](https://github.com/benson94879453/rich-war-online/issues/98) | In Review | Bind prototype card metadata to test asset reference | Prototype card metadata can support a visible card surface with optional test art and safe fallback behavior. |
